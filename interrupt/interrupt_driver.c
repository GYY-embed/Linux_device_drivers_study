...
#define IRQKEY_NAME   "interrupt_key"
...
static int __init interrupt_key_init(void)
{	
...
static void __exit interrupt_key_exit(void)
{ 
...
module_init(interrupt_key_init);
module_exit(interrupt_key_exit);
